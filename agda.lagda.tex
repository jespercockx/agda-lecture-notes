...
version 2.6.0 or later (the latest version at the time of writing is 2.8.0). There are several ways to install Agda.
\begin{description}
  \item[Download a precompiled binary.] You can download an Agda binary from \hrefu{https://github.com/agda/agda/releases}{github.com/agda/agda/releases} for the following systems:
    \begin{description}
      \item[Linux] \hrefu{https://github.com/agda/agda/releases/download/v2.8.0/Agda-v2.8.0-linux.tar.xz}{Agda-v2.8.0-linux.tar.xz}
      \item[MacOS (ARM)] \hrefu{https://github.com/agda/agda/releases/download/v2.8.0/Agda-v2.8.0-macOS-arm64.tar.xz}{Agda-v2.8.0-macOS-arm64.tar.xz}
      \item[MacOS (x64)] \hrefu{https://github.com/agda/agda/releases/download/v2.8.0/Agda-v2.8.0-macOS-x64.tar.xz}{Agda-v2.8.0-macOS-x64.tar.xz}
      \item[Windows] \href{https://github.com/agda/agda/releases/download/v2.8.0/Agda-v2.8.0-win64.zip}{Agda-v2.8.0-win64.zip}
    \end{description}
    Unpack the binary to a directory on your system path (e.g. `\texttt{/usr/bin}' on Linux and MacOS or `\texttt{C:\textbackslash{}Windows\textbackslash{}system32}' on Windows).
    Before the first usage, you need to run `\texttt{agda setup}' once from a terminal.

  \item[Ubuntu package.] On Ubuntu Linux and similar systems
    (including
    WSL\footnote{\hrefu{https://learn.microsoft.com/en-us/windows/wsl/install}{learn.microsoft.com/en-us/windows/wsl/install}}
...
Other IDEs with support for Agda are
Emacs, Neovim, and Vim.
...
If loading the file does not work, you might have to change the
configuration of the extension.
\begin{itemize}
\item \texttt{Connection: Agda version}: set this to the name of the Agda executable (usually just \texttt{agda}).
\item \texttt{Connection: Paths}: set this to the full path of the Agda executable (e.g. \texttt{/usr/bin/agda} or \texttt{C:\textbackslash{}Windows\textbackslash{}system32\textbackslash{}agda}).
\item \texttt{Connection: Download Policy}: set this to `No, and don't ask again'.
\end{itemize}
...
\begin{exercise}
  ...
  $(n-1)\ \cons\ (n-2)\ \cons\ \ldots\ \cons\ \lit{0} \cons\ \nil$. (You'll need to copy
